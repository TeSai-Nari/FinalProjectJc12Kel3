...
class ManageAdmin extends Component {
    ...
    onSaveaddDataClick=()=>{
        ...
        var typeadd=this.refs.typeadd.value
    ...
    onsaveEditClick=()=>{
        ...
        var typeedit=this.refs.typeedit.value
        ...
        if(this.props.User.role===0){
            ...
            <div className="m-5 p-5">
                ...
                <ModalBody>
                        ...
                        <input type="text" ref='typeadd' placeholder='Type Name' className='form-control mt-2'/>
                ...
                <ModalBody style={{fontSize:'14px'}}>
                    <form className="needs-validation" novalidate>
                        ...
                        <div>
                            <label> Type</label>
                            <input type="text" ref='typeedit' defaultValue={products[indexedit].type}  className='form-control mb-2' required/>
                        </div>
                        <div>
                            <label> Image </label>
